...
from utils import stereo_SGM, stereo_BM, normalise
import os
import camera

# images = ['bowling', 'cones',  'deer'] # three images from public datatset
images = range(1, 4) # self-captured images 1 to 3
for img in images:
    ...
    # TODO - please uncomment the following lines for images from public dataset
    # warp1 = img1
    # warp2 = img2
